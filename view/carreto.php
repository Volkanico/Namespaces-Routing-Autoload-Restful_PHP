...
$carreto= array (
    new camisetaPerArray("1","Camiseta llarga","Es per el fred","30"),
    new camisetaPerArray("2","Camiseta cool","Per pijos","40"),
    new camisetaPerArray("3","Camiseta chic","La moda d'avui","90"),
